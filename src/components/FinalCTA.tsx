      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center pt-6">
            <Button size="lg" variant="champagne" className="text-base shadow-glow group animate-slide-up">
              <Phone className="w-5 h-5 mr-2 group-hover:rotate-12 transition-transform" />
              Agendar Análise Completa
            </Button>
            <Button size="lg" className="text-base bg-white/10 text-white border-2 border-white/30 hover:bg-white hover:text-graphite backdrop-blur-sm animate-slide-up" style={{ animationDelay: '0.1s' }}>
